            ...
            <div class="page-header">
              <div class="row">
                ...
                <div class="col-sm-6 text-end">
                  <a href="city_form.php"><button class="btn btn-outline-primary btn-sm" type="button">Add City</button></a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="advance-1">
                        ...
                        <?php 
                            $count=0;
                                $sql="select * from tbl_city inner join tbl_state on tbl_city.state_id=tbl_state.state_id;";
                                    ...
                                    <tr>
                                     ...
                                     <td><?php echo $row["city_name"]  ?></td>
                                      ...
                                      <td>
                                        ...
                                        <a href="city_update.php?selectid=<?php echo $id; ?>"><i data-feather="edit"></i></a>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      if(isset($_POST["deletebtnM"]))
                      {
                        ...
                        mysqli_query($conn,"DELETE FROM tbl_city WHERE city_id=$delid") or die(mysqli_error($conn));
