              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Volunteer Management</li>
                  </ol>
                </div>
                <div class="col-sm-6 text-end">
                  <a href="vol_form.php"><button class="btn btn-outline-primary btn-sm" type="button">Add Volunteer</button></a>
                </div>
              </div>
            </div>
          </div>
                                    ...
                                    ?>
                                     <tr>
                                      ...
                                      <td><?php echo $row["area_name"]?></td>
                                       <td>
                                       <a href="vol_update.php?selectid=<?php echo $id; ?>"><i data-feather="edit"></i></a>
                                       ...
                                       <!-- <button class="deletebtn" data-id="<?php echo $id;  ?>" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal"><i data-feather="trash"></i></button> -->
                                      
                                       <a href="vol_viewmore.php?selectid=<?php echo $id; ?>"><i data-feather="eye"></i></a>
