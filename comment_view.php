                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              if(isset($_POST["btn_no"])) {
                                 $t = $_POST["btn_no"];
                                $sql = "UPDATE tbl_comment SET is_display='no' WHERE comment_id='$t'";
                                $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                                              
                                // Redirect
                                echo "<script>window.location='comment_view.php';</script>";
                            }
                            
                            if(isset($_POST["btn_yes"])) {
                              $t = $_POST["btn_yes"];
                             $sql = "UPDATE tbl_comment SET is_display='yes' WHERE comment_id='$t'";
                             $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
