        ...
        <div class="container-fluid">
          <div class="page-header">
            <div class="row">
              ...
              <a href="faq_form.php" class="btn btn-outline-primary btn-sm">Add FAQ </a>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="display" id="advance-1">
                      ...
                      <tbody>
                        <?php
                        $count = 0;
                        $sql = "select * from tbl_faq inner join tbl_faqcat on tbl_faq.faqcat_id=tbl_faqcat.faqcat_id;";
                        ...
                        ?>
                          ...
                          <td><?php echo $count ?> </td>
                            ...
                            <td>
                              ...
                              <a href="faq_update.php?selectedid=<?php echo $id;?>"> <i data-feather="edit"></i></a>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        if(isset($_POST["deletebtnM"]))
                      {
                        ...
                        mysqli_query($conn,"DELETE FROM tbl_faq WHERE faq_id=$delid") or die(mysqli_error($conn));
