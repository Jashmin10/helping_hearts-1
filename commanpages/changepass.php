              ...
              <form class="theme-form login-form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    <input class="form-control" type="password" required="required" placeholder="Current Password">
                    <div class="show-hide">
                      <span class="show">                         
                      </span>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    <input class="form-control" type="password" name="login[password]" required="required" placeholder="New Password">
                    <div class="show-hide">
                      <span class="show">                         
                      </span>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    <input class="form-control" type="password" name="login[password]" required="required" placeholder="Confirm Password">
                    <div class="show-hide"><span class="show">                         </span></div>
                  </div>
                </div>
                <br>
                <div class="form-group"><a class="btn btn-primary btn-block" href="#" type="submit">Change Password</a></div>
