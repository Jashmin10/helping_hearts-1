        ...
        <div class="container-fluid">
          <div class="page-header">
            <div class="row">
              ...
              <a href="state_form.php" class="btn btn-outline-primary btn-sm">Add State</a>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="table-responsive">
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="state_update.php?selectid=<?php echo $id; ?>"><i data-feather="edit"></i></a>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      if(isset($_POST["deletebtnM"]))
                      {
                        ...
                        mysqli_query($conn,"DELETE FROM tbl_state WHERE state_id=$delid") or die(mysqli_error($conn));
