                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <?php 
                        ...
                        {
                          $id = $_GET["selectid"];
                         $sql="select * from tbl_subcategory where subcat_id = $id ;";
                         ...
                         while($row = mysqli_fetch_assoc($result))
                         {
                          ...
                          <input class="form-control" name="name" type="text" placeholder="Update Sub Category" value="<?php echo $nm; ?>">
                        </div>
                        <?php
                         }
                        }
                        ...
                        {
                          $txtnm = $_POST["name"];
                           $sql= "select * from tbl_subcategory where name = '$txtnm';";
                           $result = mysqli_query($conn,$sql) or die (mysqli_error($conn));
                           $row = mysqli_num_rows($result);
                           if($row==0)
                           {
                         
                          $sql="update tbl_subcategory set name='$txtnm' where subcat_id='$id' ;";
                          $result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" name="btn_update">Update Sub Category</button>
