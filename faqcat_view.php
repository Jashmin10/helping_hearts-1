        ...
        <div class="container-fluid">
          <div class="page-header">
            <div class="row">
              ...
              <a href="faqcat_form.php" class="btn btn-outline-primary btn-sm">Add FAQ Category</a>
              </div>
            </div>
          </div>
        </div>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="faqcat_update.php?selectid=<?php echo $id; ?>"><i data-feather="edit"></i></a>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        ...
                        if(isset($_POST["deletebtnM"]))
                        {
                          ...
                          $result = mysqli_query($conn,"select * from tbl_faqcat WHERE faqcat_id=$delid;")or die(mysqli_error($conn));
                          while ($row = mysqli_fetch_assoc($result))
                          {
                            unlink("uploads/vol_img/".$row['vol_img']);
                          }
  
                          mysqli_query($conn,"DELETE FROM tbl_faqcat WHERE faqcat_id=$delid;") or die(mysqli_error($conn));
