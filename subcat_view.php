            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Sub Category Management</li>
                </ol>
              </div>
              <div class="col-sm-6 text-end text-end">
                <a href="subcat_form.php"><button class="btn btn-outline-primary btn-sm" type="button">Add Sub Category</button></a>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="table-responsive">
                    <table class="display" id="advance-1">
                      ...
                      <tbody>
                        ...
                        $count = 0;
                        //include('db_conn.php');
                        $sql = "select * from tbl_subcategory inner join tbl_category on tbl_subcategory.cat_id=tbl_category.cat_id;";
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <a href="subcat_update.php?selectid=<?php echo $id; ?>"><i data-feather="edit"></i></a>
                      ...
                      if (isset($_POST["deletebtnM"])) {
                        ...
                        mysqli_query($conn, "DELETE FROM tbl_subcategory WHERE subcat_id=$delid") or die(mysqli_error($conn));
                        echo "<script>window.location='subcat_view.php'; </script>";
                      }
                      ?>
                    </table>
                  </div>
