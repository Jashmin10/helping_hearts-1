            ...
            <div class="page-header">
              <div class="row">
                ...
                <div class="col-sm-6 text-end">
                  <a href="area_form.php"><button class="btn btn-outline-primary btn-sm" type="button">Add Area</button></a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="advance-1">
                        ...
                        <tbody>
                            ...
                            $count=0;
                            //include('db_conn.php');
                                $sql="select * from tbl_area inner join tbl_city on tbl_area.city_id=tbl_city.city_id;";
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    ...
                                    <tr>
                                     ...
                                     <td><?php echo $row["area_name"]  ?></td>
                                      <td>
                                      <a href="area_update.php?selectid=<?php echo $id; ?>"><i data-feather="edit"></i></a>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      if(isset($_POST["deletebtnM"]))
                      {
                        ...
                        mysqli_query($conn,"DELETE FROM tbl_area WHERE area_id=$delid") or die(mysqli_error($conn));
                        echo "<script>window.location='area_view.php'; </script>";
                      }
                      ?>
                      </table>
                    </div>
