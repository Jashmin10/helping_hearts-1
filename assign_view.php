          ...
          <div class="page-header">
            <div class="row">
              ...
              <div class="col-sm-6 text-end">
                <!-- <a href="assign_form.php"><button class="btn btn-outline-primary btn-sm" type="button">Add Assign</button></a> -->
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="table-responsive">
                    <table class="display" id="advance-1">
                      ...
                      if (isset($_POST["deletebtnM"])) {
                        ...
                        mysqli_query($conn, "DELETE FROM tbl_assign WHERE assign_id=$delid") or die(mysqli_error($conn));
