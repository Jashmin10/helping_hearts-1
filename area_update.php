                ...
                <div class="col-sm-12">
                  <div class="card">
                      ...
                      <?php 
                        if(isset($_GET["selectid"]))
                        {
                         ...
                         while($row = mysqli_fetch_assoc($result))
                         {
                          ...
                          <input class="form-control" name="area_name" type="text" placeholder="Update area" value="<?php echo $nm; ?>">
                        </div>
                        <?php
                         }
                        }
                        ...
                        {
                          $txtnm = $_POST["area_name"];
                           $sql= "select * from tbl_area where area_name = '$txtnm';";
                           $result = mysqli_query($conn,$sql) or die (mysqli_error($conn));
                           $row = mysqli_num_rows($result);
                           if($row==0)
                           {
                         
                          $sql="update tbl_area set area_name='$txtnm' where area_id='$id' ;";
                          $result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" name="btn_update">Update Area</button>
